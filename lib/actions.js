...
/**
 * Flush browser event loop
 */

exports.runEventLoop = function(done) {
  debug('.runEventLoop()')
  this.child.call('runEventLoop', done)
}

/**
 * Wait until the next frames have been rendered in the browser
 */

exports.waitForNextFrame = function(numFrames, done) {
  debug(`.waitForNextFrame(${numFrames})`)
  this.child.call('waitForNextFrame', numFrames, done)
}
...
exports.title_async = util.promisify(exports.title)
exports.url_async = util.promisify(exports.url)
exports.engineVersions_async = util.promisify(exports.engineVersions)
exports.path_async = util.promisify(exports.path)
exports.visible_async = util.promisify(exports.visible)
exports.exists_async = util.promisify(exports.exists)
