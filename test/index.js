...
describe('Nightmare', function() {
  ...
  describe('options', function() {
    ...
    it('should wait and fail with waitTimeout', function() {
      ...
      return nightmare.goto(fixture('navigation')).wait('foobar').should.be
        .rejected
    })
    ...
    it('should fail on authentication failure', function*() {
      nightmare = Nightmare()
      yield nightmare.authentication('my', 'wrong').goto(fixture('auth')).should
        .be.rejected
    })
  ...
  describe('ipc', function() {
    ...
    beforeEach(function() {
      ...
      Nightmare.action('noImplementation', function(done) {
  ...
  describe('partitioning', function() {
      ...
      yield nightmare
        ...
        .evaluate(function() {
          window.localStorage.setItem(
            'testing',
            'This string should not persist between instances.'
          )
        })
        .end()
    ...
    it('should persist between instances if partition is null', function*() {
      ...
      yield nightmare
        ...
        .evaluate(function() {
          window.localStorage.setItem(
            'testing',
            'This string should persist between instances.'
          )
        })
        .end()
    ...
    it('should not persist between instances if partition name doesnt start with "persist:"', function*() {
      ...
      yield nightmare
        ...
        .evaluate(function() {
          window.localStorage.setItem(
            'testing',
            'This string not should persist between instances.'
          )
        })
        .end()
    ...
    it('should persist between instances if partition starts with "persist:"', function*() {
      nightmare = Nightmare({
        webPreferences: { partition: 'persist: testing' }
      })
      yield nightmare
        .goto(fixture('simple'))
        .evaluate(function() {
